        ...
        <div class="p-5">
            <div class="contentProfile flex gap-x-2 items-center  mb-2">
                ...
                <div class="content-report">
                    <a href="/{{ $post->user->username }}"><p class="font-medium">{{ '@'.$post->user->username }}</p></a>
                </div>
            </div>
            ...
            <p class="font-medium mb-2 text-sm text-gray-500">Konten seumur hidup!</p>
            @else
            <p class="font-medium mb-2 text-sm text-gray-500">expired : {{ \Carbon\Carbon::parse($post->expired_date)->diffForHumans() }}</p>
            @endif
