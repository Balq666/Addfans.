<div>
    {{-- The Master doesn't talk, he acts. --}}
        ...
        <form action="/posts/create" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="text-white  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 @if($pastThan || $lessThan) bg-blue-200 @else bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 @endif" @if($pastThan || $lessThan)
                disabled
